...
frank.pets = ["Rover", "Daisy"]
frank.pets2 = {"Alive" : ["Rover", "Daisy"], "Dead" : ["Old Faithful", "Buddy"]}

print("Don't mind me, just testing...", frank.pets)

for x, y in frank.pets2.items():

    if x == "Alive":
        print(y, "are", x, "hooray! :D")
    elif x == "Dead":
        print(y, "have sadly passed on and are", x, "T.T")
    else:
        print("idk what you're trying to do")